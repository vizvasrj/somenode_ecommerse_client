                ...
                <Col xs='12' md='8'>
                    ...
                    {order.address && (
                        <Row>
                            ...
                            <Col xs='8'>
                                <span className='order-label one-line-ellipsis'>{` ${order.address.address}`}</span>
                                <span className='order-label one-line-ellipsis'>{` ${order.address.city}, ${order.address.state}, ${order.address.country}`}</span>
                                <span className='order-label one-line-ellipsis'>{` ${order.address.zipCode}`}</span>
                            </Col>
                        </Row>
                    )}
                </Col>
